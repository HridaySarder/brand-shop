...
const Footer = () => {
  return (
    <div className="mb-10">
      <footer className="footer p-10 bg-violet-200 text-base-content rounded-lg">
  <nav>
...
<footer className="footer px-10 py-4 border-t bg-violet-200 text-base-content border-base-300">
